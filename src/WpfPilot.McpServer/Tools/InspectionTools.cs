...
public static class InspectionTools
{
    ...
    public static Task<GetVisualTreeResponse> GetVisualTree(
        ...
        McpToolErrors.RunAsync(() => automation.GetVisualTreeAsync(windowHandle, root, depth, cancellationToken));
    ...
    public static Task<GetElementPropertiesResponse> GetElementProperties(
        ...
        CancellationToken cancellationToken = default) =>
        McpToolErrors.RunAsync(() => automation.GetElementPropertiesAsync(locator, windowHandle, cancellationToken));
}
